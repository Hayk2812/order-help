...
public class JwtUtil {
    ...
    private static final String secret_key = "orderhelpkey";
    private long accsessTokenValidity = 300;
    ...
    public String createToken(UserEntity userEntity) {
        ...
        Date tokenValidity = new Date(tokenCreateTime.getTime() + TimeUnit.SECONDS.toMillis(accsessTokenValidity));
