...
public class RestControllerExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public @ResponseBody
    ResponseEntity<ExceptionResponse> handleResourceNotFoundException(ResourceNotFoundExceptions exception) {
    ...
    public @ResponseBody
    ResponseEntity<ExceptionResponse> handleResourceAlreadyExistException(ResourceAlreadyExistsException exception) {
